...
int main(int argc, char* argv[])
{
	...
	*/
	const char* session_begin_params	=	"sub=iat,ssm=1,sch=1,sample_rate = 16000, auf=audio/L16;rate=16000,aue=speex,ent=sms16k,ptt=0,rst=json,rse=utf8,nlp_version=2.0";
	...
	printf("\n########################################################################\n");
	printf("## 语义识别(iFly Auto Transform)技术能够实时地将语音转换成对应的文字。##\n");
	printf("########################################################################\n\n");
